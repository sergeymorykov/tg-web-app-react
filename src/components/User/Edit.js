...
export default function EditProfile() {
    ...
    axios.get('http://127.0.0.1:5000/getusers?id=${user_id}')
        .then(response => {
    ...
    */
    ...
    const defaultValueInterests = []
    user.interests.map((item) => {defaultValueInterests[user.interests.indexOf(item)] = {value: item, label: item}})
    console.log(defaultValueInterests)
    return (
        ...
        <Container component="main" maxWidth="xs">
            ...
            <Box component="form" noValidate onSubmit={handleEditProfile} sx={{ mt: 3 }}>
                ...
                >
                    ...
                    <img src={user.photo} id='student_icon'  width="200" height="200"/></label> 
                    <input type="file" id="image-upload" className="upload-input" onChange={handleFileSelected}/> 
                </Grid>   
                <Grid
                    container
                    spacing={0}
                ...
                <Select
                        ...
                        defaultValue={defaultValueInterests}
